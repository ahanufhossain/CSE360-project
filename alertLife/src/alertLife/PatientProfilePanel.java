...
//					Josh	Owens
//
//Description: 		This class implements the PatientProfile panel, which displays the patient information and 
//					allows the patient to edit their information or to submit a new diagnosis entry.
/***************************************************************************************************************/
...
public class PatientProfilePanel extends JPanel {
	...
	//
	//Description:	Empty constructor for the Patient Profile Panel
	/***************************************************************************************************************/
	...
	/***************************************************************************************************************
	//Function:		PatientProfilePanel(User currentUser, Patient currentPatient, ArrayList<User> userlist, String
	//				diagnosis)
	//
	//Description:	Constructor for the Patient Profile Panel
	/***************************************************************************************************************/
	...
	/***************************************************************************************************************
	//Function:		getDoctorName(ArrayList<User> userlist)
	//
	//Description:	returns name of current patient's doctor
	/***************************************************************************************************************/
	...
	//
	//Description:	returns true if it has one or more diagnoses; returns false otherwise
	/***************************************************************************************************************/
	...
	/***************************************************************************************************************
	//Function:		getPatHistoryList()
	//
	//Description:	returns the patient history as a string array
	/***************************************************************************************************************/
	public String[] getPatHistoryList() {
		if (currentPatient.getDiagnoses().size() == 0) {
			...
			for (int i = 0; i < currentPatient.getDiagnoses().size(); i++) {
				patHistoryArrayList.add(currentPatient.getDiagnoses().get(i)
						.toShortString());
			}

			return patHistoryArrayList.toArray(new String[patHistoryArrayList
					.size()]);
		}
	}
	...
	//
	//Description:	returns the selected diagnosis in the JScroll as a String
	/***************************************************************************************************************/
